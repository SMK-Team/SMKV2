...
//════════════════════════════//
 ...
 if (!text) throw `Example : ${prefix + command} text`
 await BossRaehan.sendMedia(m.chat, `https://xteam.xyz/${command}?file&text=${text}`, 'BossRaehan', 'morou', m, {asSticker: true})
 }
 break
case 'spam': {
if (!isCreator) return
...
╠➤ $ git clone https://github.com/SMK-Team/SMKV1.git
╠➤ $ ls
